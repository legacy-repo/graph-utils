import re
from builder.ontologies.parsers import convert_obo_to_net
                    ...
                    if "xref" in attr:
                        for s in attr["xref"]:
                            ...
                            if s.startswith('DOID:'):
                                ...
                                xref = 'Phenotype'
                            if xref is not None:
                                mappings["Experimental_factor_maps_to_" +
                                         xref].add((term, s, "MAPS_TO"))
                    if "def" in attr:
